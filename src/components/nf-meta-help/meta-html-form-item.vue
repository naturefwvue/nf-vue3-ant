...
<template>
  <div class="home">
        ...
        <table>
          ...
          <tbody class="ant-table-tbody">
            <tr v-for="(item,index) in trList" :key="index"><!--遍历需要的meta-->
              <td align="right" style="padding:5px 5px;height:20px">{{helpMeta[item].colName}}：<!--名称--></td>
    ...
    <div v-if="false" align="left" style="clear:both;background-color:#EEEEFF;height:600px;width:400px;clear:both">
    <!--标准属性-->
    {<br>
